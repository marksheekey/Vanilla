...
export const onNextMonth = createAction('leave/ON_LEAVE_REQUEST_NEXT_MONTH')<void>()

export const onPrevMonth = createAction('leave/ON_LEAVE_REQUEST_PREV_MONTH')<void>()
